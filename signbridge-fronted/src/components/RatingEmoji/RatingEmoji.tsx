import style from "./RatingEmoji.module.css";
...
const RatingEmoji: React.FC<RatingEmojiProps> = ({ type, name, className, id, value, onChange, checked}) => {
        ...
        <div className={style.rating_emojis}>
            <label htmlFor={id}>
                {className === "super_happy" && (
                    <>
                        <input type={type} name={name} className={className} id={id} value={value} onChange={handleChange} checked={checked}/>
                ...
                {className === "happy" && (
                    <>
                        <input type={type} name={name} className={className} id={id} value={value} onChange={handleChange}/>
