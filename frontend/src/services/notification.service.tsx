...
export const CreateNotification = async (data: any, user: User) => {
    try {
        const response = await axiosInstance.post(`${BASE_API_URL}/notifications/create-notification`, data, {
            headers: {
...
export const GetSenderInfoBySenderId = async (senderId: any, user: User) => {
    try {
        const response = await axiosInstance.get(`${BASE_API_URL}/notifications/fetch-sender-info/${senderId}`, {
            headers: {
                Authorization: `Bearer ${await user?.getIdToken(true)}`,
            },
        });
...
export const DeleteNotification = async (notificationIds: number[], user: User) => {
    try {
        const response = await axiosInstance.delete(`${BASE_API_URL}/notifications/delete-notifications`, {
    ...
    return new Promise(async resolve => {
        try {
            ...
            resolve(() => {
                ...
                axiosInstance.delete(`${BASE_API_URL}/notifications/cleanup-stream/${tempId}`).catch(console.error);
            });
        } catch (error) {
...
//     try {
//         const response = await axiosInstance.get(`${BASE_API_URL}/notifications/fetch-notifications/${receiverId}`, {
//             headers: {
//                 Authorization: `Bearer ${await user?.getIdToken(true)}`,
//             },
//         });
...
//     try {
//         const response = await axiosInstance.get(`${BASE_API_URL}/notifications/fetch-notifications-count/${receiverId}/${status}`, {
//             headers: {
//                 Authorization: `Bearer ${await user?.getIdToken(true)}`,
//             },
//         });
